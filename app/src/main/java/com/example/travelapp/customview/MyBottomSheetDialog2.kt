...
class MyBottomSheetDialog2(var commentVo: CommentVo) : BottomSheetDialogFragment() {
    ...
    private fun initView(rootView: View) {
        ...
        myCollectionViewModel?.initCommentList(commentVo.child)
        ...
        myCollectionViewModel?.listComment?.let { replyAdapter?.setReplyList(it) }
        ...
        rootView.reply_btn_send?.setOnClickListener {
            ...
            myCollectionViewModel?.addReply2(
    ...
    override fun onResume() {
        super.onResume()
        myCollectionViewModel?.getReplySuccess()?.observe(this, {
