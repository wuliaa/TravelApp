...
class MyBottomSheetDialog3(var commentVo: CommentVo) : BottomSheetDialogFragment() {
    ...
    private fun initView(rootView: View) {
        ...
        myGuidelineViewModel?.initCommentList(commentVo.child)
        ...
        myGuidelineViewModel?.listComment?.let { replyAdapter?.setReplyList(it) }
        ...
        rootView.reply_btn_send?.setOnClickListener {
            ...
            myGuidelineViewModel?.addReply2(
    ...
    override fun onResume() {
        super.onResume()
        myGuidelineViewModel?.getReplySuccess()?.observe(this, {
